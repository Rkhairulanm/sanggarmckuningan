                ...
                <div class="col-lg-8" id="kontak">
                    <div class="col-lg-8 mt-5 mt-lg-0">
                        @if (Session::has('status'))
                            <div class="alert alert-success text-secondary opacity-5" role="alert" data-aos="fade-up"
                                data-aos-delay="200">
                                {{ Session::get('message') }}
                            </div>
                        @endif
                        <form action="/kontak-send" method="post" class="php-email-form" data-aos="fade-up"
                            data-aos-delay="200">
                            @csrf
                            <div class="row gy-4">
